...
- **Member Months** = the denominator, calculated as the sum of all enrolled members across all months in the measurement period. See [member month section](/claims-data-analytics/analytics/member-months.html) for more details. 
